...
const MONGO_DB_NAME = process.env.MONGO_DB_NAME || 'recentAuth';
...
module.exports = {
    authentication: {
        ...
        jwt: {
            ...
            issuer: 'issuer.seed06.local',
            key: ':8o.YEmN[M{TNa18pDW*f].;N^aidyU['
        },
        native: {
            bcryptHashRounds: 12,
            create: {
    ...
    dbConnections: [
        {
            mongoClientOptions: {},
            name: db_1.dbs.authentication.db,
            url
        },
        {
            mongoClientOptions: {},
            name: db_1.dbs.configdatabase.db,
            url
        }
    ],
    logging: {
