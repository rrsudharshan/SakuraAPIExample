...
function addAuthenticationAuthority(sapi, options) {
    ...
    let NativeAuthenticationAuthorityUser = class NativeAuthenticationAuthorityUser extends api_1.SapiModelMixin() {
        constructor() {
            super(...arguments);
    ...
    let AuthenticationLog = class AuthenticationLog extends api_1.SapiModelMixin() {
        constructor() {
            super(...arguments);
    ...
    let AuthenticationAuthorityApi = class AuthenticationAuthorityApi extends api_1.SapiRoutableMixin() {
